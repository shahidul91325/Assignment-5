    ...
    <div>
      <div className='md:flex lg:flex lg:flex-row lg:justify-between lg:items-center lg:text-left lg:mx-30 lg:my-10 flex flex-col text-center mx-5 my-15 '>
        <div>
          ...
          <h1 className='font-bold lg:text-6xl text-3xl bg-linear-to-r from-[#e4400e] from-20%- via-[#F04145] via-30% to-[#4d0bc0] to-70% bg-clip-text text-transparent mb-8'>Development Stack</h1>
