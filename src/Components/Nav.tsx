...
const Nav = () => {
    return (
        <div className='fixed top-0 left-0 w-full z-50 bg-white'>
            <div className=' md:flex md:justify-center md:items-center lg:flex lg:justify-between lg:items-center lg:mx-30 flex justify-between mx-3 py-4'>
                ...
                <div className='md:flex md:justify-center md:items-center lg:flex lg:justify-center lg:items-center flex justify-center items-center'>
                    ...
                    <button className='bg-[#DB2777] rounded-3xl lg:py-2 lg:px-4 text-amber-50 lg:ml-4 md:ml-2 font-semibold px-2.5 py-1 md:text-sm lg:text-sm text-[10px] ml-2'>Sign Up</button>
                </div>
            </div>
        </div>
    );
